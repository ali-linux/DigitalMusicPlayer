...
<div class="searchContainer">
	...
	<input type="text" class="searchInput" value="<?php echo $term; ?>" placeholder="Start typing..." onfocus="this.value = value">
		...
		while($row = mysqli_fetch_array($songsQuery)) {
			...
			echo "<li class='tracklistRow'>
					<div class='trackCount'>
						<img class='play' src='assets/images/icons/play-black.png' onclick='setTrack(\"" . $albumSong->getId() . "\", tempPlaylist, true)'>
