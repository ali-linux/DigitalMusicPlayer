<?php 
	$songQuery = mysqli_query($con, "SELECT id from songs ORDER BY RAND() LIMIT 6");
	$resultArray = array();
...
function setTrack(trackId, newPlaylist, play) {
	...
	$.post("includes/handlers/ajax/getSong.php", { songId: trackId }, function(data) {
		...
		$.post("includes/handlers/ajax/getArtist.php", { artistId: track.artist }, function(data) {
...
<div id="nowPlayingBarContainer">
	...
	<div id="nowPlayingBar">
		...
		<div id="nowPlayingLeft">
			<div class="content">
			<span role="link" tabindex="0" onclick="openPage('search.php')" class="albumLink">
				...
				<div class="trackInfo">
					...
					<span role="link" tabindex="0" onclick="openPage('artist.php')"></span>
					</span>

					<span class="artistName">
					<span role="link" tabindex="0" onclick="openPage('search.php')"></span>
					</span>
